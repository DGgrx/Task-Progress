...
F 1 "Arduino_Nano_v3.x" H 3750 2120 50  0000 C CNN
F 2 "Module:Arduino_Nano" H 3750 3300 50  0001 C CIN
F 3 "http://www.mouser.com/pdfdocs/Gravitech_Arduino_Nano3_0.pdf" H 3750 3300 50  0001 C CNN
	1    3750 3300
	1    0    0    -1  
$EndComp
$Comp
...
F 1 "LDR03" H 4320 905 50  0000 L CNN
F 2 "OptoDevice:R_LDR_10x8.5mm_P7.6mm_Vertical" V 4425 950 50  0001 C CNN
F 3 "http://www.elektronica-componenten.nl/WebRoot/StoreNL/Shops/61422969/54F1/BA0C/C664/31B9/2173/C0A8/2AB9/2AEF/LDR03IMP.pdf" H 4250 900 50  0001 C CNN
	1    4250 950 
	1    0    0    -1  
$EndComp
$Comp
...
F 1 "LDR03" H 4370 1605 50  0000 L CNN
F 2 "OptoDevice:R_LDR_10x8.5mm_P7.6mm_Vertical" V 4475 1650 50  0001 C CNN
F 3 "http://www.elektronica-componenten.nl/WebRoot/StoreNL/Shops/61422969/54F1/BA0C/C664/31B9/2173/C0A8/2AB9/2AEF/LDR03IMP.pdf" H 4300 1600 50  0001 C CNN
	1    4300 1650
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 6174DC47
P 5800 1450
F 0 "M?" H 5958 1446 50  0000 L CNN
F 1 "Motor_DC" H 5958 1355 50  0000 L CNN
F 2 "" H 5800 1360 50  0001 C CNN
F 3 "~" H 5800 1360 50  0001 C CNN
	1    5800 1450
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 6174E739
P 5250 1450
F 0 "M?" H 5408 1446 50  0000 L CNN
F 1 "Motor_DC" H 5408 1355 50  0000 L CNN
F 2 "" H 5250 1360 50  0001 C CNN
F 3 "~" H 5250 1360 50  0001 C CNN
	1    5250 1450
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 61750F21
P 6500 5250
F 0 "U?" H 6500 5492 50  0000 C CNN
F 1 "L7805" H 6500 5401 50  0000 C CNN
F 2 "" H 6525 5100 50  0001 L CIN
F 3 "http://www.st.com/content/ccc/resource/technical/document/datasheet/41/4f/b3/b0/12/d4/47/88/CD00000444.pdf/files/CD00000444.pdf/jcr:content/translations/en.CD00000444.pdf" H 6500 5200 50  0001 C CNN
	1    6500 5250
	-1   0    0    1   
$EndComp
$Comp
...
U 1 1 6174FFBC
P 6500 3150
F 0 "U?" H 6500 4331 50  0000 C CNN
F 1 "L293D" H 6500 4240 50  0000 C CNN
F 2 "Package_DIP:DIP-16_W7.62mm" H 6750 2400 50  0001 L CNN
F 3 "http://www.ti.com/lit/ds/symlink/l293.pdf" H 6200 3850 50  0001 C CNN
	1    6500 3150
	-1   0    0    1   
$EndComp
$EndSCHEMATC
